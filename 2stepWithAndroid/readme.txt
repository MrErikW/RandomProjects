...
After you have all of the needed stuff create a webhook in macrodroid that sends an sms when triggered and makes a variables called number and verifycode.
